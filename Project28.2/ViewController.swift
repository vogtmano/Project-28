...
//  Project28.2
//
//  Created by Maks Vogtman on 29/03/2023.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func authenticateTapped(_ sender: Any) {
        ...
        if context.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: &error) {
            ...
            ac.addAction(UIAlertAction(title: "Use password", style: .default, handler: usePassword))
            ac.addAction(UIAlertAction(title: "Pitty", style: .default))
            present(ac, animated: true)
        }
    }
    
    
    func usePassword(_ action: UIAlertAction) {
    ...
    @objc func saveSecretMessage() {
        ...
        // make the textView stop being active on the screen right now.
